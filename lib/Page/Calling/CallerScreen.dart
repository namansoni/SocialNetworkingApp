...
import 'package:insta_clone/Utils/setting.dart';
...
class CallerPage extends StatefulWidget {
  ...
  CallerPage({@required this.call,@required this.currentUser});
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          RawMaterialButton(
            onPressed: () => callMethods.endCall(call: widget.call,context: context),
            child: Icon(
              Icons.call_end,
              color: Colors.white,
              size: 35.0,
